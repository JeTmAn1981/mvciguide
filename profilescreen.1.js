...
import {Normals, Specials, MoveDetails} from './moves';
...
let moveListing =  (<View>
                            {moveList.normals[0].FrameData.length > 0 ? <StyledText style={{padding:10,fontSize:20, color:MarvelColor}}>Tap a move to view frame data!</StyledText> : null}
